...
export default function DesktopIcon({ app }: DesktopIconProps) {
  ...
  return (
    ...
    >
      <div className="w-12 h-12 bg-white border-2 border-black flex items-center justify-center shadow-button group-hover:-translate-y-1 transition-transform group-hover:bg-black group-hover:text-white">
        <app.icon size={24} />
      </div>
